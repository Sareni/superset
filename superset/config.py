...
WTF_CSRF_EXEMPT_LIST = ["superset.views.core.log", "superset.charts.api.data", "superset.datasets.api.post", "superset.charts.api.post", "superset.dashboards.api.post"]
